...
To participate in the further development of VASL and linked products,
 please read the Getting Started with VASL Development document found
in the dev documentation directory of the VASL repository on this site.
This document provides detailed instructions on obtaining, installing,
and using a number of tools necessary to enable VASL development. 
